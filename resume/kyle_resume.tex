...
\projectentry{规则引擎系统 \textit{@老虎证券}}{Flink, Spring Boot, Kafka, Redis, MySQL, REST API}{
...
\projectentry{交易所行情系统 \textit{@老虎证券}}{Flink, Kafka, Redis, DynamoDB, WebSocket, MQTT, Thrift}{
\begin{itemize}[leftmargin=0.8em, itemsep=1pt, parsep=0pt, topsep=0pt]
